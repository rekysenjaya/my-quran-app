export const ContainerSuratLoading = () => {
...
export const ContainerListSuratLoading = () => {
  return (<div className="rounded-lg shadow-md p-4 space-y-4 h-screen  animate-pulse">
    <div className=" bg-gray-500 rounded w-full h-full flex-1 p-4 flex flex-col gap-6 overflow-auto">
